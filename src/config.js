...
export const defaultConfig = {
  ...
  maxToolResultChars: parseInt(process.env.CLAUDE_CODEX_GUARD_MAX_TOOL_CHARS || '3500', 10),
  
  // How many recent tool turns to keep intact (older ones get heavily pruned)
  keepRecentToolTurns: parseInt(process.env.CLAUDE_CODEX_GUARD_KEEP_TURNS || '2', 10),
  
  // Circuit breaker: max consecutive tool steps before forcing a stop/checkpoint
  maxConsecutiveToolCalls: parseInt(process.env.CLAUDE_CODEX_GUARD_MAX_LOOPS || '12', 10),
